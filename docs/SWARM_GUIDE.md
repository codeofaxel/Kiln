...
1. Immediately append the pattern to `docs/LESSONS_LEARNED.md`
...
| `docs/LESSONS_LEARNED.md` | Technical patterns & bug fixes | When hitting unfamiliar issues |
| `docs/SWARM_GUIDE.md` | This file — system guide | When learning the system |
| `docs/roles/LOGIC.md` | Logic teammate constraints | When customizing a logic teammate |
| `docs/roles/INTERFACE.md` | Interface teammate constraints | When customizing an interface teammate |
| `docs/roles/QA.md` | QA teammate constraints | When customizing a QA teammate |
| `docs/roles/INTEGRATION.md` | Integration teammate constraints | When customizing an integration teammate |

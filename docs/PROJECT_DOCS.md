...
Kiln exposes **<!-- KILN_MCP_TOOL_COUNT:OLD --> 809 MCP tools** and **<!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 816 total MCP capabilities**. The most commonly used tools are documented below by category. Run `kiln tools` for the complete list.

...
Kiln exposes **<!-- KILN_MCP_COUNT:OLD --> 755 MCP tools** in total. The most commonly used tools are documented below by category. Run `kiln tools` for the complete list.

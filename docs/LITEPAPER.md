...
Kiln acts as a universal intelligence layer between AI agents and physical fabrication. One interface, any idea, any printer. With 543+ MCP tools and 113 CLI commands, agents have everything they need to go from concept to physical object.

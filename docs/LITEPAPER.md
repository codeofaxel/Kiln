...
Kiln acts as a universal intelligence layer between AI agents and physical fabrication. One interface, any idea, any printer. With 542+ MCP tools and 142 CLI commands, agents have everything they need to go from concept to physical object.

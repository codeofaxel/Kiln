...
Kiln acts as a universal intelligence layer between AI agents and physical fabrication. One interface, any idea, any printer. With <!-- KILN_MCP_COUNT:OLD --> 568+ MCP tools and <!-- KILN_CLI_COUNT:OLD --> 151 CLI commands, agents have everything they need to go from concept to physical object.

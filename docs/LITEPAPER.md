...
Kiln acts as a universal intelligence layer between AI agents and physical fabrication. One interface, any idea, any printer. With <!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 797 MCP capabilities and <!-- KILN_CLI_COUNT:OLD --> 220 CLI commands, agents have everything they need to go from concept to physical object.

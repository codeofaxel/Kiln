...
5. **Agent-Native Interface.** 536+ typed MCP tools with structured JSON input/output make Kiln a first-class tool for any MCP-compatible agent. 138 CLI commands with `--json` flags cover the same surface for scripting.

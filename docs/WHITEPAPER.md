...
5. **Agent-Native Interface.** 444+ typed MCP tools with structured JSON input/output make Kiln a first-class tool for any MCP-compatible agent. 143 CLI commands with `--json` flags cover the same surface for scripting.

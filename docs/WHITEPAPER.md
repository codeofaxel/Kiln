...
5. **Agent-Native Interface.** 461+ typed MCP tools with structured JSON input/output make Kiln a first-class tool for any MCP-compatible agent. 136 CLI commands with `--json` flags cover the same surface for scripting.

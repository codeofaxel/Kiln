...
AI agent control of 3D printers — <!-- KILN_MCP_COUNT:OLD --> 702 MCP tools + <!-- KILN_CLI_COUNT:OLD --> 215 CLI commands.
...
- **<!-- KILN_MCP_COUNT:OLD --> 702 MCP tools** for full printer lifecycle control

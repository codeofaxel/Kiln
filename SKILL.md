...
AI agent control of 3D printers — <!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 882 MCP capabilities + <!-- KILN_CLI_COUNT:OLD --> 233 CLI commands.
...
- **<!-- KILN_MCP_TOOL_COUNT:OLD --> 875 MCP tools** for full printer lifecycle control

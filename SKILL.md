...
AI agent control of 3D printers — <!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 836 MCP capabilities + <!-- KILN_CLI_COUNT:OLD --> 223 CLI commands.
...
- **<!-- KILN_MCP_TOOL_COUNT:OLD --> 829 MCP tools** for full printer lifecycle control

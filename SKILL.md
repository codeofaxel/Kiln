...
AI agent control of 3D printers — 536 MCP tools + 138 CLI commands.
...
- **536 MCP tools** for full printer lifecycle control
- **138 CLI commands** for human and agent use

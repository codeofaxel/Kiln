...
AI agent control of 3D printers — <!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 795 MCP capabilities + <!-- KILN_CLI_COUNT:OLD --> 218 CLI commands.
...
- **<!-- KILN_CLI_COUNT:OLD --> 218 CLI commands** for human and agent use

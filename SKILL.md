...
AI agent control of 3D printers — 533 MCP tools + 142 CLI commands.
...
- **533 MCP tools** for full printer lifecycle control
- **142 CLI commands** for human and agent use

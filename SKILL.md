...
AI agent control of 3D printers — <!-- KILN_MCP_COUNT:OLD --> 559 MCP tools + <!-- KILN_CLI_COUNT:OLD --> 151 CLI commands.
...
- **<!-- KILN_MCP_COUNT:OLD --> 559 MCP tools** for full printer lifecycle control
- **<!-- KILN_CLI_COUNT:OLD --> 151 CLI commands** for human and agent use

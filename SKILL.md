...
AI agent control of 3D printers — <!-- KILN_MCP_COUNT:OLD --> 742 MCP tools + <!-- KILN_CLI_COUNT:OLD --> 207 CLI commands.
...
- **<!-- KILN_MCP_COUNT:OLD --> 742 MCP tools** for full printer lifecycle control
- **<!-- KILN_CLI_COUNT:OLD --> 207 CLI commands** for human and agent use

...
AI agent control of 3D printers — <!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 817 MCP capabilities + <!-- KILN_CLI_COUNT:OLD --> 222 CLI commands.
...
- **<!-- KILN_MCP_TOOL_COUNT:OLD --> 810 MCP tools** for full printer lifecycle control
- **<!-- KILN_CLI_COUNT:OLD --> 222 CLI commands** for human and agent use

...
AI agent control of 3D printers — <!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 914 MCP capabilities + <!-- KILN_CLI_COUNT:OLD --> 248 CLI commands.
...
- **<!-- KILN_MCP_TOOL_COUNT:OLD --> 907 MCP tools** for full printer lifecycle control
- **<!-- KILN_CLI_COUNT:OLD --> 248 CLI commands** for human and agent use

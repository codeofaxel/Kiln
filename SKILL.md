...
AI agent control of 3D printers — <!-- KILN_MCP_COUNT:OLD --> 755 MCP tools + <!-- KILN_CLI_COUNT:OLD --> 214 CLI commands.
...
- **<!-- KILN_MCP_COUNT:OLD --> 755 MCP tools** for full printer lifecycle control

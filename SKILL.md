...
AI agent control of 3D printers — 544 MCP tools + 114 CLI commands.
...
- **544 MCP tools** for full printer lifecycle control
- **114 CLI commands** for human and agent use

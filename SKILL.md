...
AI agent control of 3D printers — <!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 911 MCP capabilities + <!-- KILN_CLI_COUNT:OLD --> 239 CLI commands.
...
- **<!-- KILN_MCP_TOOL_COUNT:OLD --> 904 MCP tools** for full printer lifecycle control

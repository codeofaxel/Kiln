...
AI agent control of 3D printers — 543 MCP tools + 113 CLI commands.
...
- **543 MCP tools** for full printer lifecycle control
- **113 CLI commands** for human and agent use

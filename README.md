...
Tool tiers auto-match model capability: **essential** (16 tools) for smaller models, **standard** (61 tools) for mid-range, **full** (133 tools) for stronger models. All 811 tools are available over MCP via `kiln serve`.
</details>
...
- **AI-native** — 818 MCP capabilities and 222 CLI commands built for AI agents. Not a web UI with an API bolted on.

...
- **AI-native** — 795 MCP capabilities and 220 CLI commands built for AI agents. Not a web UI with an API bolted on.
...
Tool tiers automatically match model capability: **essential** (15 tools) for smaller models, **standard** (46 tools) for mid-range, **full** (105 tools) for stronger models. All 788 tools are available via MCP (`kiln serve`).

...
- **AI-native** — <!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 907 MCP capabilities and <!-- KILN_CLI_COUNT:OLD --> 239 CLI commands built for AI agents. Not a web UI with an API bolted on.

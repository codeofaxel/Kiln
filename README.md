...
- **AI-native** — 795 MCP capabilities and 218 CLI commands built for AI agents. Not a web UI with an API bolted on.
...
| `cli/` | Click CLI with <!-- KILN_CLI_COUNT:OLD --> 218 commands and JSON output |

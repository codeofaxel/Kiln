...
Tool tiers auto-match model capability: **essential** (16 tools) for smaller models, **standard** (61 tools) for mid-range, **full** (133 tools) for stronger models. All <!-- KILN_MCP_TOOL_COUNT:OLD --> 870 tools are available over MCP via `kiln serve`.
</details>
...
- **AI-native** — <!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 877 MCP capabilities and <!-- KILN_CLI_COUNT:OLD --> 233 CLI commands built for AI agents. Not a web UI with an API bolted on.
...
Kiln ships **tuned profiles for 58 models across 15 brands** — Creality, Bambu Lab, QIDI, Elegoo, Prusa Research, Sovol, AON3D, Voron, AnkerMake, Artillery, FlashForge, INTAMSYS, RatRig, SparkX, Vision Miner. [See the full searchable list →](https://kiln3d.com/printers)

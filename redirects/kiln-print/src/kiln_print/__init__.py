"""
kiln-print is a redirect package. The correct package is kiln3d.
...
_warnings.warn(
    "You installed 'kiln-print'. The correct package name is 'kiln3d'. "
    "It's already installed as a dependency — just use 'import kiln' or run 'kiln' from the CLI. "
    "You can uninstall this redirect: pip uninstall kiln-print",
    UserWarning,
    stacklevel=2,
)

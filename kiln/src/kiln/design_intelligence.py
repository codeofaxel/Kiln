...
class _DesignKnowledgeBase:
    ...
    def __init__(self, domain: str = "fdm") -> None:
        ...
        # themselves drop every underscore key (that rule keeps meta and private-tier
        # fields out of the merged material dicts), so curated table-level policy —
    ...
    def skin_contact_meta(self) -> dict[str, Any]:
        ...
        uncharacterized floor.  Public curated copy, not private-tier data."""
        self._load()

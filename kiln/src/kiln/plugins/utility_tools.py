                ...
                **({"serve_process_pileup": _serve_pileup} if _serve_pileup else {}),
                ...
                "inline_3d_stage": {
                    "what": (
                        ...
                        "stage link for hosts that don't), and a slice opens "
                        "it on the file the printer will get. For a file that "
                        "reached you another way, show_on_stage opens the same "
                        "stage; never open it twice on one file. In a host "
                    ...
                    "show_me_this_file": (
                        ...
                        "a print file no slice result has just shown — the "
                        "door is show_on_stage: it opens the stage on the "

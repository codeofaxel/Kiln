...
def _build_discovery_section() -> dict[str, Any]:
    ...
    return {
        ...
        "tier_visibility_for_agents": (
            "Every tool falls in exactly one of three access classes, and you "
            "can tell which from the tool's own description — no guessing, and "
            "silence is never ambiguous:\n"
            "  (1) FREE, UNLIMITED — no tier line and no allowance line. Every "
            "tool public Kiln ships is this, plus some of kiln-pro's, including "
            "design_session, the front door for making an object. Run it "
            "freely; there is no cap to warn anyone about.\n"
            ...
            "  (3) PAID — the description carries 'Requires Kiln Pro' / "
            "'Business' / 'Enterprise' and an upgrade URL.\n"
            "The machine-readable form of the same three classes is the "
            "'access' field on each entry in pro_tool_manifest.json: 'free', "
            "'free_metered', 'pro', 'business', 'enterprise'.\n"
            ...
            "is capped, never imply a capped tool is unlimited, and never "
            "invent a number — state the allowance the description gives you."
        ),

; Bambu Lab H2C end G-code.
;
; Source: BambuStudio 02.08.02.61 vendor profile bundle, file
;   profiles/BBL/machine/"Bambu Lab H2C 0.4 nozzle template machine_end_gcode.json".
...
; refuses to emit a template it could not fully resolve.  The AMS values it
; reads besides the height are _MODEL_END_VALUES["bambu_h2c"].
;===== machine: H2C end =====
;====== date: 20260729 ======

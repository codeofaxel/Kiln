"""Regression tests for the bridging analyzer.

Lightweight helpers build minimal STL geometries on disk; the tests pin
the span measurement, the material-blind free-tier flag, and the
detection scope.  Per-material bridging limits are an overlay concern
and are pinned in kiln-pro's suite.

...
- **<!-- KILN_MCP_COUNT:OLD --> 742 MCP tools** for design intelligence, model generation, printability analysis, slicing, printing, monitoring, failure recovery, fleet management, and fulfillment
- **<!-- KILN_CLI_COUNT:OLD --> 206 CLI commands** with `--json` output for agent consumption

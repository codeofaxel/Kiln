...
The full searchable list of **70 tuned printer profiles across 15 brands** is at [kiln3d.com/printers](https://kiln3d.com/printers?utm_source=pypi&utm_medium=package-page).
...
- **<!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 930 MCP capabilities** for design intelligence, model generation, printability analysis, slicing, printing, monitoring, failure recovery, fleet management, and fulfillment
- **<!-- KILN_CLI_COUNT:OLD --> 252 CLI commands** with `--json` output for agent consumption

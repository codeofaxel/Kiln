...
- **404 MCP tools** for full printer control, fleet management, slicing, model generation, marketplace publishing, and fulfillment
...
```bash
pip install -e ".[dev]"
cd kiln && python -m pytest tests/ -v  # 7,936 tests
```

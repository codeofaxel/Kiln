...
- **542+ MCP tools** for design intelligence, model generation, printability analysis, slicing, printing, monitoring, failure recovery, fleet management, and fulfillment
- **114 CLI commands** with `--json` output for agent consumption

...
> **Reading this as an AI agent?** [**kiln3d.com/agents**](https://kiln3d.com/agents?utm_source=pypi&utm_medium=package-page) is written for you rather than for the person running you: install, MCP config, the design-to-print loop, and exactly what Kiln will refuse to do and why.
...
The full searchable list of **64 tuned printer profiles across 15 brands** is at [kiln3d.com/printers](https://kiln3d.com/printers?utm_source=pypi&utm_medium=package-page).
...
- **<!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 914 MCP capabilities** for design intelligence, model generation, printability analysis, slicing, printing, monitoring, failure recovery, fleet management, and fulfillment
- **<!-- KILN_CLI_COUNT:OLD --> 248 CLI commands** with `--json` output for agent consumption

...
The full searchable list of **69 tuned printer profiles across 15 brands** is at [kiln3d.com/printers](https://kiln3d.com/printers?utm_source=pypi&utm_medium=package-page).
...
- **<!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 918 MCP capabilities** for design intelligence, model generation, printability analysis, slicing, printing, monitoring, failure recovery, fleet management, and fulfillment

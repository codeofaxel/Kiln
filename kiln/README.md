...
- **432 MCP tools** for full printer control, fleet management, slicing, model generation, marketplace publishing, and fulfillment
- **132 CLI commands** with `--json` output for agent consumption

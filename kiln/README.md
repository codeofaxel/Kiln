...
- **<!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 899 MCP capabilities** for design intelligence, model generation, printability analysis, slicing, printing, monitoring, failure recovery, fleet management, and fulfillment

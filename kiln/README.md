...
- **<!-- KILN_MCP_CAPABILITY_COUNT:OLD --> 826 MCP capabilities** for design intelligence, model generation, printability analysis, slicing, printing, monitoring, failure recovery, fleet management, and fulfillment
- **<!-- KILN_CLI_COUNT:OLD --> 223 CLI commands** with `--json` output for agent consumption
